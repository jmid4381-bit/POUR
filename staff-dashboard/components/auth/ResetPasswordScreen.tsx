        ...
        <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-card">
          ...
          {done ? (
            <div className="p-6 text-center space-y-3">
              ...
              <p className="text-slate-500 text-xs font-body">Signing you in…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div>
                <p className="text-[10px] font-mono text-slate-600 uppercase tracking-wider mb-1.5">New Password</p>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <p className="text-[10px] font-mono text-slate-600 uppercase tracking-wider mb-1.5">Confirm Password</p>
                <input
                  type="password"
