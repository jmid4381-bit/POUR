    ...
    <div className="fixed inset-0 z-50 bg-void flex items-center justify-center p-4">
      ...
      <form onSubmit={handleSubmit} className="relative z-10 w-full max-w-sm animate-fade-up">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-2xl text-white mb-1">Staff Sign In</h1>
        ...
        <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-card">
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <p className="text-[10px] font-mono text-slate-600 uppercase tracking-wider mb-1.5">Password</p>
              <input
                type="password"
                value={password}
