  ...
  return (
    <div className="fixed inset-0 z-50 bg-void flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm animate-fade-up">
          ...
          {showForgot ? (
            resetSent ? (
              ...
              <form onSubmit={handleForgotSubmit} className="p-5 space-y-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-ink-400 uppercase tracking-wider mb-1.5">Email</p>
                  <input
                    type="email"
                    value={resetEmail}
                ...
                <button
                  ...
                  className="w-full text-center text-ink-400 hover:text-white text-xs font-body font-semibold transition-colors inline-flex items-center justify-center gap-1"
                >
                  <ArrowLeft size={12} /> Back to sign in
                </button>
              </form>
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <p className="text-[10px] font-mono text-ink-400 uppercase tracking-wider">Password</p>
                  <button
                    type="button"
        ...
        <p className="text-center text-[11px] text-ink-400 font-mono mt-4">
